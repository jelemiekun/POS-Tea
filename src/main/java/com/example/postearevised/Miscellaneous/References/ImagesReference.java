...
public class ImagesReference {
    ...
    public static final Image DELETE_RED = new Image(Objects.requireNonNull(GeneralReference.class.getResourceAsStream("/com/example/postearevised/Medias/Buttons/delete red.png")));
