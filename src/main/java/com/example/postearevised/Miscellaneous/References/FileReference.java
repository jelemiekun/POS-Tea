...
public class FileReference {
    ...
    public static final String DIRECTORY_PATH_ACCOUNTS;
    ...
    public static final String TEXT_PATH_ORDER_RECEIPT_CUSTOMER_COPY;
    public static final String TEXT_PATH_ORDER_RECEIPT_STORE_COPY;
